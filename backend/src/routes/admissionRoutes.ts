...
import { applyForAdmission, getMyStatus, getAllApplications, downloadApplicationPDF, downloadResultPDF, updateApplicationStatus, updateMyProfile } from '../controllers/admissionController.js';
