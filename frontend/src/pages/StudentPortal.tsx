...
const StudentPortal: React.FC = () => {
    ...
    if (loading) return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-white dark:bg-slate-950">
            <div className="w-16 h-16 border-4 border-tharqiya-green border-t-transparent rounded-full animate-spin" />
    ...
    if (!user) return (
        <div className="min-h-screen flex items-center justify-center bg-white dark:bg-slate-950">
            <div className="text-center">
                <h2 className="text-2xl font-black font-outfit text-slate-900 dark:text-white mb-4 tracking-tight">Unauthorized Session</h2>
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-slate-950 pt-32 pb-20 px-4 transition-colors duration-500">
            <div className="absolute inset-0 opacity-[0.02] dark:opacity-[0.05] islamic-pattern pointer-events-none" />
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                >
                    <div className="absolute top-0 right-0 w-64 h-full bg-tharqiya-green/5 dark:bg-tharqiya-gold/5 skew-x-12" />
                    <div className="flex flex-col md:flex-row items-center gap-10">
                        <div className="relative">
                            <div className="w-28 h-28 bg-white rounded-[2.5rem] flex items-center justify-center shadow-2xl rotate-3 overflow-hidden p-3 border border-slate-100">
                        ...
                        <div className="text-center md:text-left">
                            <h1 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white font-outfit tracking-tighter mb-2">
                                Assalam-u-Alaikum, <span className="text-transparent bg-clip-text bg-gradient-to-r from-tharqiya-green to-tharqiya-light-green dark:from-tharqiya-gold dark:to-islamic-accent">{user.name.split(' ')[0]}</span>
                            </h1>
                            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
                                ...
                                <span className="px-4 py-1.5 bg-tharqiya-green/10 dark:bg-tharqiya-gold/10 text-tharqiya-green dark:text-tharqiya-gold rounded-full text-xs font-black uppercase tracking-widest border border-tharqiya-green/20 dark:border-tharqiya-gold/20">Post-Hifz 2026</span>
                            </div>
                        </div>
                        <div className="md:ml-auto">
                            <button className="p-4 bg-slate-100 dark:bg-slate-900 text-slate-400 dark:text-slate-500 rounded-2xl relative hover:text-tharqiya-green dark:hover:text-tharqiya-gold transition-colors">
                                <Bell size={24} />
                ...
                {!appData ? (
                    ...
                    >
                        ...
                        <h2 className="text-3xl font-black text-slate-900 dark:text-white mb-4 tracking-tight font-outfit">Your Journey Awaits</h2>
                    ...
                    <div className="grid lg:grid-cols-3 gap-10">
                        ...
                        >
                            <div className="glass-card p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 relative group overflow-hidden">
                                <div className="absolute top-0 left-0 w-2 h-full bg-tharqiya-green dark:bg-tharqiya-gold" />
                                <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-8 font-outfit tracking-tight">Application Dossier</h3>
                                <div className="grid gap-6">
                                    {[
                                        ...
                                        <div key={i} className="flex justify-between items-center py-4 border-b border-slate-50 dark:border-slate-800 last:border-0">
                                            ...
                                            <span className={`font-bold text-lg ${row.highlight ? 'text-tharqiya-green dark:text-tharqiya-gold' : row.success ? 'text-emerald-500' : 'text-slate-800 dark:text-slate-200'}`}>
                                                {row.value}
                                            </span>
                                        </div>
                                    ))}
                        ...
                        >
                            ...
                            {appData.status === 'ACCEPTED' && (
                                <motion.button
                                    ...
                                    className="w-full bg-tharqiya-gold dark:bg-islamic-accent text-white dark:text-slate-950 py-6 rounded-[2rem] font-black text-lg shadow-2xl shadow-tharqiya-gold/30 flex items-center justify-center gap-3 uppercase tracking-widest"
                                >
